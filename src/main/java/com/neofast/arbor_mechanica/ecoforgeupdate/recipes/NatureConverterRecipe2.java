...
public record NatureConverterRecipe2(Ingredient inputItem, ItemStack output) implements Recipe<NatureConverterRecipeInput2> {
    ...
    public boolean matches(NatureConverterRecipeInput2 natureConverterRecipeInput2, Level level) {
        ...
        return inputItem.test(natureConverterRecipeInput2.getItem(0));
    }
    ...
    public RecipeSerializer<?> getSerializer() {
        return Recipes.NATURA_CONVERTER_SERIALIZER2.get();
    }

    @Override
    public RecipeType<?> getType() {
        return Recipes.NATURA_CONVERTER_TYPE2.get();
    }
