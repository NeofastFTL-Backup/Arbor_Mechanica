...
import com.neofast.arbor_mechanica.ecoforgeupdate.block.entities.CuttingMachineEntity;
...
public class CuttingMachineMenu extends AbstractContainerMenu {
    ...
    public CuttingMachineMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
