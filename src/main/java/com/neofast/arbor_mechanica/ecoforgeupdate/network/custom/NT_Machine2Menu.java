...
import com.neofast.arbor_mechanica.ecoforgeupdate.block.entities.NT_MachineEntity2;
...
public class NT_Machine2Menu extends AbstractContainerMenu {
    ...
    public NT_Machine2Menu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
